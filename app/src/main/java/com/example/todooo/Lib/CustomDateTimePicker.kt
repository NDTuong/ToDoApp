...
class CustomDateTimePicker(
    ...
    private val dateTimePickerLayout: View
        get() {
            ...
            btnSetDate?.apply {
                ...
                text = context.getString(R.string.set_date)
                id = SET_DATE
            ...
            btnSetTime?.apply {
                layoutParams = buttonParams
                text = activity?.getString(R.string.set_time)
                id = SET_TIME
                setTextColor(ContextCompat.getColor(context, R.color.black))
                background = context.getDrawable(R.color.white)
                setOnClickListener(this@CustomDateTimePicker)
            ...
            btnSet?.apply {
                layoutParams = buttonParams
                text = activity?.getString(R.string.btn_done)
                id = SET
                isAllCaps = false
            ...
            btnClear?.apply {
                layoutParams = buttonParams
                text = activity?.getString(R.string.btn_clear)
                id = CLEAR
                isAllCaps = false
                setTextColor(ContextCompat.getColor(context, R.color.primary_color))
                background = context.getDrawable(R.color.white)
            ...
            btnCancel?.apply {
                layoutParams = buttonParams
                text = activity?.getString(R.string.btn_cancel)
                id = CANCEL
                isAllCaps = false
                setTextColor(ContextCompat.getColor(context, R.color.primary_color))
                background = context.getDrawable(R.color.white)
    ...
    interface ICustomDateTimeListener {
        fun onSet(
                ...
                hour12: Int, min: Int, sec: Int, AM_PM: String, isClear: Boolean
        )
    ...
    override fun onClick(v: View) {
        when (v.id) {
            SET_DATE -> {
                ...
                btnSetDate!!.setTextColor(ContextCompat.getColor(activity!!, R.color.primary_color))
                btnSetTime!!.setTextColor(ContextCompat.getColor(activity!!, R.color.black))
            ...
            SET_TIME -> {
                ...
                btnSetDate!!.setTextColor(ContextCompat.getColor(activity!!, R.color.black))
                btnSetTime!!.setTextColor(ContextCompat.getColor(activity!!, R.color.primary_color))
