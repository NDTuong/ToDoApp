...
//        alertDialog.setTitle(strTitle);
        ...
        LinearLayout llAddNewTag = rootView.findViewById(R.id.llAddNewTag);
        llAddNewTag.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void openInputTag() {
        ...
        dialog.setContentView(R.layout.dialog_input_tag);
